...
<body class="bg-yellow-400">
    ...
    <header class="bg-blue-500 text-white shadow-lg" x-data="{ open: false }">
        ...
        <div x-show="open" class="md:hidden px-4 pb-4 space-y-2 mb-10">
    ...
    <section class="relative bg-gradient-to-r from-white-600 to-white-500 text-white py-16 md:py-30 overflow-hidden ">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="service-card bg-white rounded-lg overflow-hidden shadow-md transition duration-300 transform hover:scale-105">
                    <div class="h-48 bg-center bg-cover bg-no-repeat" style="background-image: url('guaritasebanheiros.jpg');"> </div>
                    <div class="p-6 bg-white">
                        <h3 class="text-xl font-bold text-blue-700 mb-2">Locação de Banheiros Químicos e Guaritas</h3>
                        <p class="text-gray-600 mb-4"> Banheiros químicos e guaritas para eventos, obras e situações temporárias. Higiene e comodidade garantida. </p>
                ...
                <div class="service-card bg-white rounded-lg overflow-hidden shadow-md transition duration-300 transform hover:scale-105">
                    <div class="service-card bg-white rounded-lg overflow-hidden shadow-md transition duration-300 transform hover:scale-105">
                    <div class="h-48 bg-center bg-cover bg-no-repeat" style="background-image: url('desentupimento.jpg');"> </div>
                    </div>
                    <div class="p-6 bg-white">
    ...
    <section id="contact" class="py-16 bg-blue-600 text-white">
        <div class="container mx-auto px-4">
          ...
          <section>
  <div class="lg:flex lg:space-x-10 items-stretch">
    <div class="lg:w-1/2 mb-10 lg:mb-0">
      <form
        action="https://formsubmit.co/caiobambiental@gmail.com"
        method="POST"
        class="form bg-blue-300 p-6 rounded-lg space-y-4 h-full"
      >
        <label for="name" class="block text-white font-semibold">Nome</label>
        <input
          type="text"
          name="name"
          id="name"
          required
          class="w-full px-4 py-2 border border-white text-white rounded-lg placeholder-white focus:outline-none focus:ring-2 focus:ring-white"
        />
        ...
        <div>
          ...
          <select
            ...
            id="service"
            required
            class="w-full px-4 py-2 border border-white bg-white-200 text-blue-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-white"
          >
            <option value="">Selecione um serviço</option>
            <option value="banheiros">Banheiros Químicos e Guaritas</option>
        ...
        <label for="message" class="block text-white font-semibold"
          >Mensagem</label
        >
        <textarea
          name="message"
        ...
        <button
          type="submit"
          class="w-full bg-white text-blue-600 font-bold py-3 px-4 rounded-lg hover:bg-white-100 transition shadow"
        >
          Enviar
        </button>
      </form>
      ...
      <div class="bg-blue-300 rounded-lg shadow-xl p-6 h-full">
        ...
        <div class="space-y-6">
          <div class="flex items-start">
            ...
            <div>
              ...
              <p class="text-white-100">
                <a href="tel:+554199159904" class="hover:text-white transition"
                  >(41) 99915-9904</a
                >
              </p>
            </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              ...
              <p class="text-white-100">
                <a
                  href="mailto:caiobambiental@gmail.com"
                  class="hover:text-white transition"
                  >caiobambiental@gmail.com</a
                >
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              ...
              <p class="text-white-100">
                Segunda a Sexta: 8h às 18h Sábado 8h ás 12h
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="mt-10">
          ...
          <div class="flex space-x-4">
            <a
              href="https://www.facebook.com/share/16M3EfDNd6/"
              class="bg-blue-600 hover:bg-blue-800 text-white p-3 rounded-full transition hover:text-yellow-300 transition"
            >
              <i class="fab fa-facebook-f"></i>
            </a>
            <a
              href="https://www.instagram.com/caiobaambiental?igsh=OXhuYm9sdWNkZDZ2"
              class="bg-blue-600 hover:bg-blue-800 text-white p-3 rounded-full transition hover:text-yellow-300 transition"
            >
              <i class="fab fa-instagram"></i>
            </a>
            <a
              href="https://wa.me/message/2BCTETMDSEXDD1"
              class="bg-blue-600 hover:bg-blue-800 text-white p-3 rounded-full transition hover:text-yellow-300 transition"
            >
